...
function Part3() {
    ...
    const abrirModal = (src) => setImagenActiva(src)
                ...
                <div className="scroll-container">
                    ...
                    <div className="part-container">
                        ...
                        <section className="container-img">
                            <img src="/Analisis foda peti.jpeg" alt="Análisis FODA" onClick={() => abrirModal("/Analisis foda peti.jpeg")} />
                        </section>

                        <h1 id="Foda ponderado">Foda ponderado</h1>
                        <section className="container-img">
                            <img src="/Foda ponderado.png" alt="FODA Ponderado" onClick={() => abrirModal("/Foda ponderado.png")} />
                            <img src="/Resultado.JPG" alt="Resultado" onClick={() => abrirModal("/Resultado.JPG")} />
                        </section>

                        {imagenActiva && (
                            <div className="modal" onClick={cerrarModal}>
                                <img src={imagenActiva} alt="Zoom" />
                            </div>
                        )}
                        ...
                        <section>
                            ...
                            <div className="pregunta-card">
                                F2: Acceso y tiempo suficiente para la revisión
                            </div>
                            <div className="pregunta-card">
                                F3: Presupuesto para renovación de equipos
                            </div>
                            <div className="pregunta-card">
                                F4: Infraestructura tecnológica adecuada
                            </div>

                            <div className="pregunta-card">
                                F5: Automatización de alertas
                            </div>

                            <div className="pregunta-card">
                                F6: Asignación eficiente de horarios
                            </div>

                            <div className="pregunta-card">
                                F7: Gestión de licencias
                            </div>
                        </section>
